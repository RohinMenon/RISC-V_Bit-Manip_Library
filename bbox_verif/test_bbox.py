...
with open('bbox_verif/base.txt', 'r') as file:
    base = file.readline().strip('\n').split(' ')[2]  # Set as RV64 or RV32
file.close()
...
Za_test_instr64 = [(0b0000100_000_0111011,'adduw',0),(0b0010000_010_0110011,'sh1add',0),(0b0010000_010_0111011,'sh1adduw',0),
                (0b0010000_100_0110011,'sh2add',0),(0b0010000_100_0111011,'sh2adduw',0),
                (0b0010000_110_0110011,'sh3add',0),(0b0010000_110_0111011,'sh3adduw',0),(0b000010_001_0011011,'slliuw',1)]
...
Zs_test_instr32 = [(0b0100100_001_0110011,'bclr',0),(0b0100100_001_0010011,'bclri32',1),(0b0100100_101_0110011,'bext',0),(0b0100100_101_0010011,'bexti32',1),
                (0b0110100_001_0110011,'binv',0),(0b0110100_001_0010011,'binvi32',1),(0b0010100_001_0110011,'bset',0),(0b0010100_001_0010011,'bseti32',1)]

Zs_test_instr64 = [(0b0100100_001_0110011,'bclr',0),(0b010010_001_0010011,'bclri64',1),(0b0100100_101_0110011,'bext',0),(0b010010_101_0010011,'bexti64',1),
                (0b0110100_001_0110011,'binv',0),(0b011010_001_0010011,'binvi64',1),(0b0010100_001_0110011,'bset',0),(0b001010_001_0010011,'bseti64',1)]
